...
class ModSysHome extends StatefulWidget {
  @override
  _ModSysHomeState createState() => _ModSysHomeState();
}

class _ModSysHomeState extends State<ModSysHome> with TickerProviderStateMixin {
              ...
              () {
                setState(
                  () {
                    ...
                    //   Navigator.pushNamed(context, 'CpuControll');
                    //   // Navigator.of(context).push<void>(RippleRoute(
                    //   //     CpuControll(), RouteConfig.fromContext(context)));
                    // } else {
                    //   // showNeedRootToast();
                    // }
                  },
